# ShiftCut Design System & Style Guide

Use this guide to configure Mintlify docs or any other platform to match the ShiftCut brand.
...
- **No heavy shadows** — ShiftCut uses a flat, minimal aesthetic
...
- **Logo**: "ShiftCut" in `--font-display` at 600 weight
