 ...
 * Mintlify serves them at `https://shiftcut.verblike.com/schema/*`. The core
 * copies stay authoritative — they're exported from `@shiftcut/core` for
 ...
 *
 * `docs/schema/shiftcut.json` is authored directly in docs (no source in
