...
description: "Complete reference for authoring Shiftcut HTML compositions."
---

This is the full schema reference for Shiftcut compositions. For a gentler introduction, see [Compositions](/concepts/compositions) and [Data Attributes](/concepts/data-attributes).
...
<Check>
  ...
  - Run `npx shiftcut lint` to catch structural issues automatically
</Check>
