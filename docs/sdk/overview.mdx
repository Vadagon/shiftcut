...
`@shiftcut/sdk` is the editing engine inside ShiftCut Studio and the CLI. It opens composition HTML, exposes query and mutation APIs, emits RFC 6902 JSON patches, tracks undo/redo, and persists changes through pluggable adapters — all without requiring React, Studio, or a browser UI.
...
<CardGroup cols={2}>
  ...
  <Card title="Types" icon="brackets-curly" href="/sdk/reference/types">
    ShiftCutElement, FindQuery, PatchEvent, OverrideSet, and more.
  </Card>
