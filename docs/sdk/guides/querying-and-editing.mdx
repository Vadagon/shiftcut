...
Each `ElementSnapshot` (aliased from `ShiftCutElement`) carries:
...
```typescript
import type { FindQuery } from "@shiftcut/sdk";
...
<CardGroup cols={2}>
  ...
  <Card title="Types reference" icon="brackets-curly" href="/sdk/reference/types">
    ShiftCutElement, FindQuery, ElementHandle, SelectionProxy, and more.
  </Card>
