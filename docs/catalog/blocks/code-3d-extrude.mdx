...
<video className="w-full aspect-video rounded-xl object-cover bg-zinc-100 dark:bg-zinc-800" src="https://static.heygen.ai/shiftcut-oss/docs/images/catalog/blocks/code-3d-extrude.mp4" poster="https://static.heygen.ai/shiftcut-oss/docs/images/catalog/blocks/code-3d-extrude.png" autoPlay muted loop playsInline />
