...
<Tip>
  To skip the picker and install everything (core + every workflow) in one shot, run `npx skills add Verblike/shiftcut --all`.
</Tip>
...
<Note>
  Claude Design uses a different entry path. Open [`docs/guides/claude-design-shiftcut.md`](https://github.com/Verblike/shiftcut/blob/main/docs/guides/claude-design-shiftcut.md) on GitHub, click the download button (↓) to save it, then attach to your Claude Design chat. It produces a valid first draft you can refine in any AI coding agent. See the [Claude Design guide](/guides/claude-design).
</Note>
