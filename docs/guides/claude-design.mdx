...
<Steps>
  <Step title="Download the instruction file">
    Open [`claude-design-shiftcut.md`](https://github.com/Verblike/shiftcut/blob/main/docs/guides/claude-design-shiftcut.md) on GitHub and click the download button (↓) to save it.
  </Step>
...
| --------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Claude Design               | Download [`claude-design-shiftcut.md`](https://github.com/Verblike/shiftcut/blob/main/docs/guides/claude-design-shiftcut.md) from GitHub and attach to your chat |
