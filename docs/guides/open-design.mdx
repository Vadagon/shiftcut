...
<Steps>
  <Step title="Download the instruction file">
    Open [`open-design-shiftcut.md`](https://github.com/Verblike/shiftcut/blob/main/docs/guides/open-design-shiftcut.md) on GitHub and click the download button (↓) to save it.
  </Step>
  ...
  <Step title="Refine in any AI coding agent">
    ...
    ```bash
    cd .od/projects/<id>
    npx skills add Verblike/shiftcut   # install skills (one-time)
...
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Open Design (open-source)              | Drop [`open-design-shiftcut.md`](https://github.com/Verblike/shiftcut/blob/main/docs/guides/open-design-shiftcut.md) into `skills/shiftcut-handoff/SKILL.md`   |
| Claude Code                            | `npx skills add Verblike/shiftcut`, then use `/shiftcut`                                                                                                             |
| Cursor / Codex / Gemini CLI            | `npx skills add Verblike/shiftcut`                                                                                                                                       |
| Claude Design (closed-source)          | Attach [`claude-design-shiftcut.md`](https://github.com/Verblike/shiftcut/blob/main/docs/guides/claude-design-shiftcut.md) to your chat                          |
...
npx skills add Verblike/shiftcut   # one-time setup
