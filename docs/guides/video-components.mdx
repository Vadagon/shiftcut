...
<Tip>
  Using an AI agent? Install the ShiftCut skills with `npx skills add Verblike/shiftcut` and ask it to "add a chart block" — the `/shiftcut-registry` skill discovers, installs, and wires the catalog item for you.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Open a component request" icon="lightbulb" href="https://github.com/Verblike/shiftcut/issues/new">
