...
<img src="https://static.heygen.ai/shiftcut-oss/docs/images/comparisons/gsap-hf.gif" alt="Shiftcut GSAP render — letters enter, hold, then fall away over the full 4 seconds" />
...
<img src="https://static.heygen.ai/shiftcut-oss/docs/images/comparisons/gsap-remotion.gif" alt="Remotion GSAP render — GSAP plays through its entire timeline in the first second, leaving most of the render as an empty stage" />
