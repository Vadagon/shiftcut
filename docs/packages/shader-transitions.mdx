---
title: "@shiftcut/shader-transitions"
description: "WebGL shader transitions for ShiftCut scenes and compositions."
---

The shader transitions package adds GPU-accelerated scene-to-scene transitions to ShiftCut compositions. It captures scene samples, uploads them as WebGL textures, and drives fragment-shader compositing from a GSAP timeline.
...
**Use `@shiftcut/shader-transitions` when you need to:**
