...
Open an issue on [GitHub](https://github.com/Verblike/shiftcut/issues) with a visual reference. Tag it `component-request`.
...
<Steps>
  <Step title="Fork and create">
    Fork [Verblike/shiftcut](https://github.com/Verblike/shiftcut) and create your block directory:
    ```bash
