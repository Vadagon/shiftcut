...
This page documents the current manual DOM editing surface in ShiftCut Studio. It reflects the implementation that ships in the Studio inspector today, not the earlier design draft that explored third-party transform engines.
