...
description: How ShiftCut keeps alpha-only work out of stable releases.
---

ShiftCut publishes two release channels:
...
```bash
npm install shiftcut@alpha
npm install @shiftcut/core@alpha
```
