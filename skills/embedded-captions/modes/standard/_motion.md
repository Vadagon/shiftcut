...
- `shiftcut-gsap` — single paused timeline, transform aliases, ease list, the animated-property allowlist.
- `_anatomy.md` — where these four hooks attach.
- `shiftcut-animation/rules/asr-keyword-glow.md` — the verbatim active-word envelope for the flow.
