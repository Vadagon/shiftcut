 ...
 *
 * shiftcut' renderer only auto-supplies its ~18 CANONICAL_FONTS. Every other
 ...
 * On a clean/offline/CI machine it silently degrades. (shiftcut' own font
 ...
 * HTML, shiftcut-canonical families, and CSS generics are left untouched.
 *
...
// inline style="") and the data-font-family attribute shiftcut also honors.
