...
const ANIMATION_DIR = resolve(SKILL_DIR, "../shiftcut-animation");
...
export function buildFramePackets({
  ...
  outDir = join(projectDir, ".shiftcut", "frame-packets"),
...
function main() {
  ...
  try {
    const packets = buildFramePackets({
      ...
      outDir: resolve(flag(argv, "out-dir", join(projectDir, ".shiftcut", "frame-packets"))),
    });
