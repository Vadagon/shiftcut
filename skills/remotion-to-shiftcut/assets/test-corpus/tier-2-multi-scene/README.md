...
The scene crossfading is a ShiftCut idiom, not a Remotion one: at scene boundaries
...
# 3. Render ShiftCut translation
cd ../hf-src && npx shiftcut render --output ../hf.mp4
