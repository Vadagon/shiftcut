...
| `clockWipe()`                      | use HF's `sdf-iris` shader-transition (`npx shiftcut add sdf-iris`)                    |
...
(iris, ripple, zoom, glitch), use HF's [shader-transitions](https://shiftcut.verblike.com/catalog/blocks)
