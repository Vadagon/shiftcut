...
The smallest renderable ShiftCut composition — a standalone (top-level) root with one clip and one tween:
...
<html lang="en">
  <head>
    ...
    <title>Minimal ShiftCut Composition</title>
