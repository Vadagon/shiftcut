#!/usr/bin/env node
// animation-map.mjs — ShiftCut animation map for agents
//
...
const packages = await importPackagesOrBootstrap(
  ["@shiftcut/producer", "@shiftcut/core", "@shiftcut/core/compiler"],
  {
    npmPackages: [
...
const OUT_DIR = resolve(args.out ?? ".shiftcut/anim-map");
