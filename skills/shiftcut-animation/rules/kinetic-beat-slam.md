...
- **One accent hue, heavy weight** — embedded display faces (Archivo Black, League Gothic, Oswald) at 150px+; see `shiftcut-creative/references/typography.md`.
...
- `/shiftcut-animation` — timeline + easing vocabulary (`../../adapters/gsap-easing-and-stagger.md`)
- `/shiftcut-creative` — `references/video-composition.md` (foreground rhythm chrome), `references/typography.md` (embedded display fonts)
- `/shiftcut-core` — composition wiring, determinism (finite repeats)
