...
- **One accent hue, consistent blueprint** — see `shiftcut-creative/references/data-in-motion.md`.
...
- `/shiftcut-animation` — timeline + transform tweens
- `/shiftcut-creative` — `references/data-in-motion.md` (stat layout + visual weight)
- `/shiftcut-core` — composition wiring; the no-`width`/`height`-tween rule
