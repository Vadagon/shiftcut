...
- `/shiftcut-animation` — timeline + ease reference; `y:` tween basics
- `/shiftcut-core` — composition wiring, `data-*` attributes
- `/shiftcut-cli` — `shiftcut lint` to verify the registry key + duration
