...
const MODELS = {
  ...
  asr: [
    ...
    },
    {
      ...
      notes:
        "CPU-only fallback (no GPU): faster-whisper + wav2vec2 forced alignment, native word timestamps. The packaged `shiftcut transcribe` (whisper.cpp) is the zero-setup baseline below this.",
    },
  ],
  upscale: [
    {
