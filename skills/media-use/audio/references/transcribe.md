...
```bash
npx shiftcut transcribe audio.mp3  --model small.en             # known English
npx shiftcut transcribe video.mp4  --model small --language es  # known Spanish
npx shiftcut transcribe audio.mp3  --model small                # unknown language (auto-detect)
npx shiftcut transcribe subtitles.srt                           # import existing
npx shiftcut transcribe subtitles.vtt
