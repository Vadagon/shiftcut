...
//
// Usage:
//   node wait-bgm.mjs --audio-meta ./audio_meta.json --shiftcut . \
...
const outPath = resolve(flag("out", join(shiftcutDir, "bgm_status.json")));
...
const bgmAbsPath = bgmPath ? join(shiftcutDir, bgmPath) : "";
