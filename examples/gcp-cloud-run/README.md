...
End-to-end deployment + smoke for [`@shiftcut/gcp-cloud-run`](../../packages/gcp-cloud-run) — the Cloud Run + Cloud Workflows adapter for ShiftCut distributed rendering.
