...
describe("ShiftcutPlayer parent-frame media", () => {
  ...
  beforeEach(async () => {
    await import("./shiftcut-player.js");
    ...
    player = document.createElement("shiftcut-player") as PlayerElement;
  });
  ...
  it("does not mute iframe media on autoplay fallback inside presenter slideshow", () => {
    const slideshow = document.createElement("shiftcut-slideshow");
...
describe("ShiftcutPlayer shader transition options", () => {
  ...
  it("passes shader options through src query parameters", () => {
    const player = document.createElement("shiftcut-player") as PlayerWithIframe;
  ...
  it("injects shader options into srcdoc before composition scripts run", () => {
    ...
    expect(srcdoc.indexOf("data-shiftcut-player-shader-options")).toBeLessThan(
...
describe("ShiftcutPlayer adoptedStyleSheets", () => {
  ...
  it("shares a single CSSStyleSheet across multiple player instances", () => {
    const a = document.createElement("shiftcut-player") as PlayerWithShadow;
    const b = document.createElement("shiftcut-player") as PlayerWithShadow;
  ...
  it("does not inject a per-instance <style> when adoption succeeds", () => {
    const player = document.createElement("shiftcut-player") as PlayerWithShadow;
    document.body.appendChild(player);
...
describe("ShiftcutPlayer media MutationObserver scoping", () => {
  ...
  it("attaches the observer to each top-level composition host (not the body)", () => {
    ...
    const player = document.createElement("shiftcut-player") as PlayerInternal;
    document.body.appendChild(player);
...
describe("ShiftcutPlayer parent-proxy time-mirror coalescing", () => {
  type DriftEntry = {
  ...
  beforeEach(async () => {
    await import("./shiftcut-player.js");
    player = document.createElement("shiftcut-player") as PlayerInternal;
    document.body.appendChild(player);
  ...
  it("initializes new parent-media entries with driftSamples=0", () => {
    ...
    const fresh = document.createElement("shiftcut-player") as PlayerInternal;
...
describe("ShiftcutPlayer seek() sync path", () => {
  type SyncPlayerStub = {
    seek?: (t: number) => void;
    play?: () => void;
    pause?: () => void;
...
describe("ShiftcutPlayer loop end-state handling", () => {
  type PlayerInternal = HTMLElement & {
    iframe: HTMLIFrameElement;
    play: () => void;
...
describe("ShiftcutPlayer srcdoc attribute", () => {
  type PlayerInternal = HTMLElement & {
    iframe: HTMLIFrameElement;
    _ready: boolean;
  };
  ...
  it("includes srcdoc in observedAttributes", () => {
    ...
    const ctor = customElements.get("shiftcut-player") as
...
describe("ShiftcutPlayer volume and mute", () => {
  ...
  beforeEach(async () => {
    ...
    player = document.createElement("shiftcut-player") as typeof player;
  });
...
describe("ShiftcutPlayer audio lock", () => {
...
describe("ShiftcutPlayer runtime ready handshake", () => {
...
describe("ShiftcutPlayer audio lock — Claude desktop UA fallback", () => {
...
describe("ShiftcutPlayer playback rate", () => {
  let player: HTMLElement & {
    playbackRate: number;
    iframeElement: HTMLIFrameElement;
  };
...
describe("ShiftcutPlayer composition dimension attributes", () => {
  ...
  beforeEach(async () => {
    await import("./shiftcut-player.js");
    player = document.createElement("shiftcut-player") as PlayerWithDimensions;
    document.body.appendChild(player);
  });
