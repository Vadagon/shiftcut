...
export interface ShiftCutElement {
  readonly id: string;
  /**
  ...
  readonly tag: string;
  readonly children: readonly ShiftCutElement[];
...
export interface SdkDocument {
  readonly roots: readonly ShiftCutElement[];
 ...
 */
export const ORIGIN_APPLY_PATCHES = "@shiftcut/sdk:applyPatches" as const;
...
export type ElementSnapshot = ShiftCutElement;
