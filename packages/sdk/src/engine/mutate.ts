...
import { mintHfId, EXCLUDED_TAGS } from "@shiftcut/core/hf-ids";
import { EDIT_BASE_X_ATTR, EDIT_BASE_Y_ATTR } from "@shiftcut/core/runtime/position-edits";
import { readClipTiming, writeClipTiming } from "@shiftcut/core/composition-contract";
import { parseGsapScriptAcornForWrite } from "@shiftcut/core/gsap-parser-acorn";
import type { GsapAnimation } from "@shiftcut/core/gsap-parser";
import {
...
} from "@shiftcut/core/gsap-writer-acorn";
...
import type { CompositionVariable } from "@shiftcut/core/variables";
import {
  URI_BEARING_ATTRS,
  DANGEROUS_URI_SCHEMES,
  DANGEROUS_DATA_URI,
} from "@shiftcut/core/html-attr-safety";
...
function handleMoveElement(
  ...
  // emitted by shiftcut generator). CSS left/top is not the convention.
  //
