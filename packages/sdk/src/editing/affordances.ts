...
import { resolveEditingAffordances, type EditingAffordances } from "@shiftcut/core/editing";
import type { ShiftCutElement } from "../types.js";
...
type ModelFacts = Pick<ShiftCutElement, "text" | "animationIds" | "start">;
