...
export function resolveGsapWriter(env: { SHIFTCUT_GSAP_WRITER?: string }): "recast" | "acorn" {
  const configured = env.SHIFTCUT_GSAP_WRITER ?? "recast";
