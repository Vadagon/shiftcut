...
> {
  return {
    maxBytes: positiveEnvNumber("SHIFTCUT_PROXY_CACHE_MAX_BYTES", DEFAULT_MAX_BYTES),
    maxIdleMs: positiveEnvNumber("SHIFTCUT_PROXY_CACHE_MAX_IDLE_DAYS", 30) * 24 * 60 * 60 * 1000,
    staleTempMs: positiveEnvNumber("SHIFTCUT_PROXY_CACHE_STALE_TEMP_MS", DEFAULT_STALE_TEMP_MS),
    minSweepIntervalMs: positiveEnvNumber(
      "SHIFTCUT_PROXY_CACHE_SWEEP_INTERVAL_MS",
