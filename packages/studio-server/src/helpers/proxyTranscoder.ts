...
const MAX_CONCURRENT_TRANSCODES = boundedEnvInteger("SHIFTCUT_PROXY_MAX_CONCURRENCY", 2, 1, 16);
const MAX_QUEUED_TRANSCODES = boundedEnvInteger("SHIFTCUT_PROXY_MAX_QUEUE", 8, 0, 256);
