...
export function wrapScopedCompositionScript(
  source: string,
  compositionId: string,
  errorLabel = "[ShiftCut] composition script error:",
  scopeSelectorOverride?: string,
  ...
  var __hfBaseShiftcut = window.__shiftcut;
  var __hfScopedShiftcut = !__hfBaseShiftcut
    ? __hfBaseShiftcut
    : Object.assign({}, __hfBaseShiftcut, {
  ...
  var __hfRun = function() {
    try {
      (function(document, gsap, window, __shiftcut) {
${source.replace(/<\/(script)/gi, "<\\/$1")}
      }).call(window, __hfScopedDocument, __hfScopedGsap, __hfScopedWindow, __hfScopedShiftcut);
    } catch (_err) {
