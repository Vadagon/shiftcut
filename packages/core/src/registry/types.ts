...
export type ItemType = "shiftcut:example" | "shiftcut:block" | "shiftcut:component";

/** File-level classification, drives installer behavior. */
export type FileType =
  | "shiftcut:composition"
  | "shiftcut:asset"
  | "shiftcut:snippet"
  | "shiftcut:style"
  | "shiftcut:timeline";
...
interface RegistryItemBase {
  /** JSON Schema URL — `https://shiftcut.verblike.com/schema/registry-item.json`. */
  $schema?: string;
  ...
  license?: string;
  /** Minimum `shiftcut` CLI version required to install this item (semver). */
  ...
  /** Related skill slug (e.g. `shiftcut-captions`) — shown in docs. */
  relatedSkill?: string;
}

/** Full-project example — scaffolded by `shiftcut init --example <name>`. */
...
/** Sub-composition block — installed by `shiftcut add <name>`. */
...
export interface RegistryManifest {
  /** JSON Schema URL — `https://shiftcut.verblike.com/schema/registry.json`. */
  $schema?: string;
  /** Registry name (e.g. `shiftcut`). */
  name: string;
...
export const ITEM_TYPE_DIRS = {
  "shiftcut:example": "examples",
  "shiftcut:block": "blocks",
  "shiftcut:component": "components",
