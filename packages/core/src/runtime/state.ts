...
export type RuntimeState = {
   ...
   * protocol between the parent (`<shiftcut-player>`) and this runtime.
   ...
   * audio-mirror loop in `<shiftcut-player>` waits for
   ...
   * `packages/player/src/shiftcut-player.ts` — leaving it at `2` will
