 ...
 * the user passes `shiftcut render --variables '<json>'`).
 *
 ...
 * `__shiftcut.getVariables` with a scoped variant that returns the
...
/** Render-time variable overrides (`shiftcut render --variables`). */
