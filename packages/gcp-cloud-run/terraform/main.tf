# ShiftCut distributed render stack on Google Cloud.
#
...
resource "google_service_account" "run_sa" {
  ...
  project      = var.project_id
  display_name = "ShiftCut render service (Cloud Run)"
}

resource "google_service_account" "workflow_sa" {
  account_id   = "${local.name}-wf"
  project      = var.project_id
  display_name = "ShiftCut render orchestration (Workflows)"
}
