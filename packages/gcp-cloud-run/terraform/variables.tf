...
variable "image" {
  type        = string
  description = "Fully-qualified container image for the render service (e.g. us-central1-docker.pkg.dev/PROJECT/REPO/shiftcut-render:TAG), built from packages/gcp-cloud-run/Dockerfile."
}
