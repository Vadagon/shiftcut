 ...
 * `@shiftcut/producer/distributed` and is shared with the other adapters.
...
import { InvalidConfigError } from "@shiftcut/producer/distributed";
...
const LARGE_VARIABLES_DOCS_URL =
  "https://shiftcut.verblike.com/deploy/templates-on-lambda#working-with-large-variables";
