/**
 * `@shiftcut/gcp-cloud-run` — Google Cloud Run + Workflows adapter for
 * the ShiftCut distributed render pipeline.
 *
 ...
 * is NOT a dependency of `@shiftcut/producer`; consumers install it
 * separately.
 */
