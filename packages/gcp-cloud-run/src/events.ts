/**
 * Request + result types for the ShiftCut distributed render handler
 ...
 *
 * These shapes are intentionally identical to `@shiftcut/aws-lambda`'s
...
export type { SerializableDistributedRenderConfig } from "@shiftcut/producer/distributed";
