#!/usr/bin/env node
/**
 * Build script for @shiftcut/gcp-cloud-run (public OSS package).
 *
...
// drops the workspace `paths` overrides so `@shiftcut/producer` resolves
