...
Most users should use `@shiftcut/producer` or the `shiftcut` CLI instead of calling the engine directly.

## Documentation

Full documentation: [shiftcut.verblike.com/packages/engine](https://shiftcut.verblike.com/packages/engine)

## Related packages

- [`@shiftcut/core`](../core) — types, parsers, frame adapters
- [`@shiftcut/producer`](../producer) — high-level render pipeline built on this engine
- [`shiftcut`](../cli) — CLI
