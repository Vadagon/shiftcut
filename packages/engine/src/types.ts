/**
 * @shiftcut/engine — Protocol Types
 *
 ...
 *
 * Compositions using @shiftcut/shader-transitions populate
...
export interface HfProtocol {
  ...
  /** Optional: shader transition metadata, populated by @shiftcut/shader-transitions */
