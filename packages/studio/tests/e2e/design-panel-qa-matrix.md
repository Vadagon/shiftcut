...
Environment: published CLI `shiftcut@0.7.26`, embedded mode (`npx shiftcut preview`
...
- Action: click the "Shiftcut" H1 (from `compositions/intro.html`, embedded in `index.html`).
