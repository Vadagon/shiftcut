...
export const TIMELINE_ASSET_MIME = "application/x-shiftcut-asset";
export const TIMELINE_BLOCK_MIME = "application/x-shiftcut-block";
 ...
 * ShiftCut allows time-overlap on a track; the user can nudge if they want a gap.
 */
