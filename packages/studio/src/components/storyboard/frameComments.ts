import type { FrameStatus } from "@shiftcut/core/storyboard";
 ...
 * skills/shiftcut-core/references/storyboard-format.md § Frame comments.
 */
export const FRAME_COMMENTS_PATH = ".shiftcut/frame-comments.json";
