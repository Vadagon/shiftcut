...
// Mirrors `CanvasResolution` from @shiftcut/core. Kept local because
...
export interface StartRenderOptions {
   ...
   * `shiftcut render --variables` uses.
   */
    ...
    async (opts: StartRenderOptions = {}) => {
      ...
      try {
        ...
        const failedJob: RenderJob = {
          ...
          status: "failed",
          progress: 0,
          error: "Could not reach render server. Use `shiftcut render` from the CLI instead.",
