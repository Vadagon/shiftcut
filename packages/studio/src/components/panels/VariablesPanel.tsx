...
import { isScalarVariableValue as isScalar } from "@shiftcut/core/variables";
...
function HandoffFooter({
  ...
  const command = `npx shiftcut render ${shellSingleQuote(compPath)} --variables ${shellSingleQuote(json)}`;
  return (
