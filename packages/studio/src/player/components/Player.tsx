...
import { isLottieAnimationLoaded } from "@shiftcut/core/runtime/lottie-readiness";
import { useMountEffect } from "../../hooks/useMountEffect";
import { applyPreviewVariablesToUrl } from "../../hooks/previewVariablesStore";
import { ShiftcutLoader } from "../../components/ui";
// NOTE: importing "@shiftcut/player" registers a class extending HTMLElement
...
interface ShiftcutPlayerElement extends HTMLElement {
...
function enableInteractiveIframe(player: ShiftcutPlayerElement): void {
...
/**
 * Renders a composition preview using the <shiftcut-player> web component.
 *
...
export const Player = forwardRef<HTMLIFrameElement, PlayerProps>(
  (
    ...
    useMountEffect(() => {
      ...
      import("@shiftcut/player").then(() => {
        if (canceled) return;

        // Create the web component imperatively to avoid JSX custom-element typing.
        const player = document.createElement("shiftcut-player") as ShiftcutPlayerElement;
