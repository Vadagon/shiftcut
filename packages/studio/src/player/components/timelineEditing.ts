...
export function buildTimelineAgentPrompt({
  ...
  return `Edit the following ShiftCut composition:
...
The composition uses ShiftCut data attributes (data-start, data-duration, data-track-index) and GSAP for animations.
