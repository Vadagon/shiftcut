...
import { readClipTiming } from "@shiftcut/core/composition-contract";
import {
 ...
 * - Custom elements (e.g. `<shiftcut-player>`) whose shadow DOM contains an iframe
 ...
 * const playerElRef = useRef<ShiftcutPlayer>(null);
 *
 * useEffect(() => {
