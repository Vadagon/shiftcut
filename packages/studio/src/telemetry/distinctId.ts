...
//   - `shiftcut-studio:anonymousId` (telemetry/config.ts → studio_* + render events)
...
// (a random UUID from ~/.shiftcut/config.json) as `window.__HF_CLI_DISTINCT_ID`
...
export const DISTINCT_ID_KEY = "shiftcut-studio:anonymousId";
 ...
 * means "this Studio was launched by the ShiftCut CLI, adopt its identity".
 */
