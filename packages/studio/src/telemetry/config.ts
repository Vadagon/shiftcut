...
//   localStorage.setItem('shiftcut-studio:telemetryDisabled','1')
// ---------------------------------------------------------------------------
...
const NOTICE_KEY = "shiftcut-studio:telemetryNoticeShown";
...
const SESSION_FIRED_KEY = "shiftcut-studio:sessionStartFired";
