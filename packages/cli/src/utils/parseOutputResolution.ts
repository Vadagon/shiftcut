 ...
 * render entrypoints (`shiftcut cloudrun render{,-batch}`, `shiftcut
 * lambda render{,-batch}`) plus the local `shiftcut render` command.
 *
...
import { type CanvasResolution, resolveResolutionFlagPair } from "@shiftcut/core";
import { VALID_CANVAS_RESOLUTIONS } from "@shiftcut/core";
