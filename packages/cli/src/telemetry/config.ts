...
// ---------------------------------------------------------------------------
// Config directory: ~/.shiftcut/
// ---------------------------------------------------------------------------

const CONFIG_DIR = join(homedir(), ".shiftcut");
const CONFIG_FILE = join(CONFIG_DIR, "config.json");

export interface ShiftcutConfig {
...
const DEFAULT_CONFIG: ShiftcutConfig = {
...
let cachedConfig: ShiftcutConfig | null = null;
 ...
 */
export function readConfig(): ShiftcutConfig {
  ...
  try {
    ...
    const parsed = JSON.parse(raw) as Partial<ShiftcutConfig>;

    const config: ShiftcutConfig = {
 ...
 */
export function readConfigFresh(): ShiftcutConfig {
  cachedConfig = null;
  return readConfig();
}
 ...
 */
export function writeConfig(config: ShiftcutConfig): boolean {
  try {
