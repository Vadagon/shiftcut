...
export async function captionImagesWithGemini(
  ...
  // provider via SHIFTCUT_OPENROUTER_MODEL / SHIFTCUT_GEMINI_MODEL.
  const model = useOpenRouter
    ? process.env.SHIFTCUT_OPENROUTER_MODEL || "google/gemini-3.1-flash-lite"
    : process.env.SHIFTCUT_GEMINI_MODEL || "gemini-3.1-flash-lite-preview";
