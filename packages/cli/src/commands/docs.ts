...
export const examples: Example[] = [
  ["List all available topics", "shiftcut docs"],
  ["Read about data attributes", "shiftcut docs data-attributes"],
  ["Read about rendering", "shiftcut docs rendering"],
  ["Read about GSAP integration", "shiftcut docs gsap"],
];
...
export default defineCommand({
  ...
  async run({ args }) {
    ...
    if (topic === undefined || topic === "") {
      ...
      console.log();
      console.log(c.dim(`Run ${c.accent("shiftcut docs <topic>")} to view a topic.`));
      return;
    }
