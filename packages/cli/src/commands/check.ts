...
export const examples: Example[] = [
  ["Run the full verification gate", "shiftcut check"],
  ["Output one agent-readable envelope", "shiftcut check --json"],
  ["Persist the five audited contrast frames", "shiftcut check --snapshots"],
  ["Also fail on warnings", "shiftcut check --strict"],
];
  ...
  return defineCommand({
    ...
    args: {
      ...
      proxy: {
        type: "boolean",
        description:
          "Auto-transcode browser-hostile video codecs (default: shiftcut.json media.autoProxy, which defaults on)",
        default: undefined,
      },
      snapshots: {
        type: "boolean",
