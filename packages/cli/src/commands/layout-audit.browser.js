(function () {
  ...
  window.__shiftcutGeometryCandidates = function collectGeometryCandidates(options) {
  ...
  window.__shiftcutLayoutAudit = function auditLayout(options) {
  ...
  window.__shiftcutLayoutGeometry = function collectLayoutGeometry() {
    const root =
      document.querySelector("[data-composition-id][data-width][data-height]") ||
      document.querySelector("[data-composition-id]") ||
      document.body;
