...
import { parseGsapScript, type GsapAnimation } from "@shiftcut/core/gsap-parser";
...
export const examples: Example[] = [
  ["Surface every keyframe + motion path in the project", "shiftcut keyframes"],
  ["Inspect one composition file", "shiftcut keyframes compositions/scene.html"],
  ["Machine-readable output for an agent", "shiftcut keyframes --json"],
  ["Only one element's keyframes", "shiftcut keyframes --selector '#puck-a'"],
  ["Runtime-aware hint for CSS/Anime compositions", "shiftcut keyframes --runtime all"],
];
