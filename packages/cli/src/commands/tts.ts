...
export const examples: Example[] = [
  ["Generate speech from text", 'shiftcut tts "Welcome to ShiftCut"'],
  ["Choose a voice", 'shiftcut tts "Hello world" --voice am_adam'],
  ["Save to a specific file", 'shiftcut tts "Intro" --voice bf_emma --output narration.wav'],
  ["Adjust speech speed", 'shiftcut tts "Slow and clear" --speed 0.8'],
  [
    "Generate Spanish speech",
    'shiftcut tts "La reunión empieza a las nueve" --voice ef_dora --output es.wav',
  ],
  [
    "Override phonemizer language",
    'shiftcut tts "Ciao a tutti" --voice af_heart --lang it --output accented.wav',
  ],
  ["Read text from a file", "shiftcut tts script.txt"],
  ["List available voices", "shiftcut tts --list"],
];
