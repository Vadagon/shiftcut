...
export const examples: Example[] = [
  ["Lint the current project", "shiftcut lint"],
  ["Lint a specific directory", "shiftcut lint ./my-video"],
  ["Output findings as JSON", "shiftcut lint --json"],
  ["Include info-level findings", "shiftcut lint --verbose"],
];
...
export default defineCommand({
  ...
  async run({ args }) {
    ...
    // `shiftcut lint --json | ...` on Windows silently loses the entire JSON
