...
export const examples: Example[] = [
  [
    ...
    "shiftcut grade-compare --for frame.png --grades grades.json",
  ],
  [
    "Compare LUT files and print agent-friendly JSON",
    "shiftcut grade-compare --for frame.png --luts looks/a.cube,looks/b.cube --json",
  ],
];
...
<html lang="en">
  <head>
    ...
    <title>ShiftCut Grade Compare</title>
