...
import { findMusicAudioSrc, audioRelPathForSrc, serializeBeats } from "@shiftcut/core/beats";
...
export const examples: Example[] = [
  ["Generate the beat file for the current project", "shiftcut beats"],
  ["Generate for a specific directory", "shiftcut beats ./my-video"],
];
