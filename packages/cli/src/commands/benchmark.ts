...
export const examples: Example[] = [
  ["Run benchmarks with default settings (3 runs)", "shiftcut benchmark"],
  ["Run 5 iterations per config", "shiftcut benchmark --runs 5"],
  ["Output results as JSON", "shiftcut benchmark --json"],
];
...
import { fpsToFfmpegArg } from "@shiftcut/core";
...
const FPS_30: import("@shiftcut/core").Fps = { num: 30, den: 1 };
const FPS_60: import("@shiftcut/core").Fps = { num: 60, den: 1 };
    ...
    try {
      ...
      if (jsonOutput) {
        ...
        errorBox(
          ...
          "Ensure @shiftcut/producer is built and linked.",
        );
      }
      process.exit(1);
    }
