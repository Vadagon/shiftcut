...
export const examples: Example[] = [
  ["Capture a website into ./capture/", "shiftcut capture https://stripe.com"],
  ["Capture to a different directory", "shiftcut capture https://linear.app -o linear-video"],
  ["JSON output for AI agents", "shiftcut capture https://example.com --json"],
  [
    "Pull a video from the captured manifest by index",
    "shiftcut capture --video ./linear-video --index 0",
  ],
  [
    "List videos referenced in the captured manifest",
    "shiftcut capture --video ./linear-video --list",
  ],
];
...
export default defineCommand({
  meta: {
    name: "capture",
    description: "Capture a website as editable ShiftCut components",
  },
  args: {
    url: {
      type: "positional",
