...
import { parseNumeric, parseStartExpression } from "@shiftcut/core";
import type { Example } from "./_examples.js";
import { existsSync, readFileSync } from "node:fs";
import { resolve, dirname } from "node:path";

export const examples: Example[] = [
  ["List compositions in the current project", "shiftcut compositions"],
  ["Output as JSON", "shiftcut compositions --json"],
];
