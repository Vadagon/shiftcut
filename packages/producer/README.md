...
```typescript
import { startServer } from "@shiftcut/producer";
...
Full documentation: [shiftcut.verblike.com/packages/producer](https://shiftcut.verblike.com/packages/producer)

## Related packages

- [`@shiftcut/core`](../core) — types, parsers, frame adapters
- [`@shiftcut/engine`](../engine) — lower-level capture and encode primitives
- [`shiftcut`](../cli) — CLI
