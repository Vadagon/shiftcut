 ...
 *
 * Drives the OSS `@shiftcut/aws-lambda` handler through the exact
...
import { downloadS3ObjectToFile, tarDirectory, untarDirectory } from "@shiftcut/aws-lambda";
import { handler } from "@shiftcut/aws-lambda/handler";
import type {
  AssembleEvent,
