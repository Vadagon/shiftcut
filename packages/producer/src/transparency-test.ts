 ...
 * this script via `bun run --filter @shiftcut/producer test:transparency`
...
import { decodePng, runFfmpeg } from "@shiftcut/engine";
...
const WIDTH = 200;
const HEIGHT = 200;
const FPS: import("@shiftcut/core").Fps = { num: 30, den: 1 };
