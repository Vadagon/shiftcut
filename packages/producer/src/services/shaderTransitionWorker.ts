...
// subpath export of `@shiftcut/engine` rather than the package root.
// Rationale:
//
...
//    redirects `@shiftcut/engine/shader-transitions` to the same TS
//    source and bundles it inline, so behavior is identical.
import { TRANSITIONS, crossfade } from "@shiftcut/engine/shader-transitions";
