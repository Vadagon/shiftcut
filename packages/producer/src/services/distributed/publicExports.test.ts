 ...
 *
 *   1. `import { plan, renderChunk, assemble } from "@shiftcut/producer"`
 *      — the canonical package entry. Includes the three activity functions
 *      and their result types.
 *
 *   2. `import { plan, renderChunk, assemble } from "@shiftcut/producer/distributed"`
 ...
 * `../../index.js` paths rather than `"@shiftcut/producer"` because the
...
describe("@shiftcut/producer/distributed (subpath)", () => {
...
describe("@shiftcut/producer (main entry)", () => {
