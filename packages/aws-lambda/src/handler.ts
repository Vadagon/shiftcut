/**
 * AWS Lambda handler for ShiftCut distributed rendering.
 *
 ...
 * the matching OSS primitive from `@shiftcut/producer/distributed`.
 *
 ...
 *
 * Skipped when `SHIFTCUT_RENDER_BUCKET` is unset so existing deployments
