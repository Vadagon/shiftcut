/**
 * Structural snapshot of {@link ShiftcutRenderStack}.
 *
...
function doSynth(): {
  ...
  new ShiftcutRenderStack(stack, "Render", { handlerZipPath: join(zipDir, "handler.zip") });
...
describe("ShiftcutRenderStack — snapshot", () => {
