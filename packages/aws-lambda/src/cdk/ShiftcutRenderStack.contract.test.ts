/**
 * Contract tests for {@link ShiftcutRenderStack}.
 *
...
import { ShiftcutRenderStack } from "./ShiftcutRenderStack.js";
...
function synthFixture(): Template {
  ...
  new ShiftcutRenderStack(stack, "Render", { handlerZipPath: zipPath });
  return Template.fromStack(stack);
}

describe("ShiftcutRenderStack — contract", () => {
  beforeAll(() => {
  ...
  it("honours reservedConcurrency when supplied", () => {
    ...
    const app = new App();
    const stack = new Stack(app, "TestStack");
    new ShiftcutRenderStack(stack, "Render", {
