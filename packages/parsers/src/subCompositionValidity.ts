 ...
 * `@shiftcut/parsers` (rather than `@shiftcut/core`, where it
 * originated) because `@shiftcut/lint` needs it too, and `lint` cannot
 ...
 *
 * `inlineSubCompositions.ts` (in `@shiftcut/core`) intentionally stays
