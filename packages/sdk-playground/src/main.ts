import { openComposition } from "@shiftcut/sdk";
import { createFileAdapter } from "./fileAdapter.js";
import type { Composition, GsapTweenSpec, PreviewAdapter, FindQuery } from "@shiftcut/sdk";
import { parseGsapScriptAcorn } from "@shiftcut/core/gsap-parser-acorn";
import type { GsapAnimation } from "@shiftcut/core";
...
<div data-hf-id="hf-stage" data-hf-root style="width:1280px;height:720px;background:#111827;position:relative;" data-duration="6">
  ...
  <div data-hf-id="hf-sub" style="position:absolute;top:300px;left:142px;font-size:28px;color:#9ca3af;font-family:system-ui,sans-serif;">@shiftcut/sdk &middot; Phase 3b</div>
